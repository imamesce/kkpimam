...
public class ModelPesan implements Serializable {
    ...
    public ModelPesan(String tanggal_berangkat) {
        this.tanggal_berangkat = tanggal_berangkat;
    }
    ...
    public ModelPesan(Date dibuat, String id, String nama_wisata, String id_transaksi, String harga_wisata, String keterangan, String keterangan_wisata) {
        this.dibuat = dibuat;
        this.id = id;
        this.nama_wisata = nama_wisata;
        this.id_transaksi = id_transaksi;
